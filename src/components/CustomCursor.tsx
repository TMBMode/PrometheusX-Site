...
const CustomCursor: React.FC = () => {
  ...
  return (
    <div
      ref={cursorRef}
      className={`fixed pointer-events-none z-[9999] transition-opacity duration-150 scale-75 md:scale-[85%] lg:scale-100 ${
      ...
      style={{
        ...
        transform: isClicked ? 'rotate(20deg)' : 'rotate(10deg)',
