...
const Navigation: React.FC<NavigationProps> = ({ currentSection, onNavigate }) => {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-6 right-6 portrait:bottom-0 portrait:right-0 origin-bottom-right scale-75 md:scale-85 lg:scale-100 z-50 pointer-events-auto-main" style={navSlideInStyle}>
